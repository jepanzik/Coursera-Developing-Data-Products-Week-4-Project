---
title: "Comparing Effect of Ozone Levels on Temperature by Month"
author: "J.E. Panzik"
date: "6/16/2020"
...
p1 <- ggplot(data=data, aes(x=Ozone, y=Temp)) + geom_point(aes(color=Month)) +
      xlab("Ozone (ppb)") + ylab("Temperature (F)") + ylim(55, 100) +
      xlim(0, 170) + geom_smooth(method='lm')

p2 <- ggplot(data=data, aes(x=Ozone, y=Temp, color=Month)) + geom_point() +
      xlab("Ozone (ppb)") + ylab("Temperature (F)") + ylim(55, 100) +
      xlim(0, 170) + geom_smooth(method='lm')
